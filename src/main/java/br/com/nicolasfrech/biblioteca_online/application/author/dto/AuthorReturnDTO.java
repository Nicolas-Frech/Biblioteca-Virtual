...
public record AuthorReturnDTO(Long id, String name, List<Book> books, List<Genre> genres, LocalDate birthdate) {
    public AuthorReturnDTO(Author author) {
        this(author.getId(), author.getName(), author.getBooks(), author.getGenres(), author.getBirthdate());
    }
}
